...
(function(){
 ...
 function mount(app){
  ...
  const groups=[{title:L('Discover','اكتشف'),keys:['home','course','lab','news','hub']},{title:L('Your campus','مساحتك الدراسية'),keys:['progress','calendar','alerts','messages']},{title:L('Manage','الإدارة'),keys:['administration','staff','people','privacy','settings']}];
