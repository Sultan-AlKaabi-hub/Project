...
const SHELL = "rasid-shell-v4";
const DATA = "rasid-data-v4";
const SHELL_FILES = ["./", "index.html", "css/app.css", "js/i18n.js", "js/sprite.js", "js/intro.js", "js/faris.js", "js/app.js", "js/curriculum-data.js", "js/local-api.js", "vendor/webauthn.js", "manifest.webmanifest", "icons/icon.svg", "icons/icon-192.png", "icons/icon-512.png"];
