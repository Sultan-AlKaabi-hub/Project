...
export function source(d,lang){return {lessonId:d.lessonId,moduleId:d.moduleId,courseId:d.courseId,title:d.title[lang],difficulty:d.difficulty,topic:d.topic[lang],contentType:d.contentType};}
